                            ...
                            <td>
                                ...
                                <div className="modal-content">
                                    <p className="image is-4by3">
                                        <img src={ URL_API + '/news/images/' + item.fileimg } width="100%" alt="" />
                                    </p>
                                </div>
                                <button onClick={ () => showimage(item.id) } class="modal-close is-large" aria-label="close"></button>
                                </div>                            
                                <img onClick={ () => showimage(item.id) } src={ URL_API + '/news/images/' + item.fileimg } alt="Foto" width="10%" srcset=""/>
                            </td>
