...
export default function AdminCadastroNoticias(props) {
    ...
    async function handleSubmit(e) {
        ...
        if (props.id) {
            response = await axios.put(URL_API + '/practices/' + props.id, data)
            
        } else {
            //faz o envio dos dados captados no formulário de cadastro de noticias
            response = await axios.post(URL_API + '/practices', data)
    ...
    //         }
    //     }
    //     const resp = await axios.post(URL_API + '/practices/' + response.data.id + '/images', formData, config)
    // }
    setTimeout( () => {
        Router.push('/admin/listagemPratica')
    },1000) 
    ...
    useEffect(
        () => {
            async function loadingPractice() {
                ...
                const response = await axios.get(URL_API + '/practices/' + props.id)
                    ...
                    <div className="p-1 mx-5">
                        <div className="columns is-desktop">
                            <div className="column">
                                <h1 className="is-size-1">Práticas</h1>
                                <h2 className="is-size-4">Cadastar uma nova Prática</h2>
                            </div>
                        </div>
                        {/* {JSON.stringify(data)} */}
                        <Menssagem close={ closeMsg } visible={ msgVisible }>Prática Cadastrada com sucesso !</Menssagem>
                        <div className="columns is-desktop">
                            <div className="column">
                                <div className="field">
