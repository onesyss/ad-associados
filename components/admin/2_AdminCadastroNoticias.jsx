                            ...
                            <div className="column">
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <input onChange={handleChange} value={data.category} className="input is-medium" type="text" name="category" placeholder="Categoría" />
                                ...
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <input onChange={handleChange} value={data.maintitle} className="input is-medium" type="text" name="maintitle" placeholder="Título Principal" />
                                        <span className="icon is-left">
                                ...
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <input onChange={handleChange} value={data.subtitle} className="input is-medium" type="text" name="subtitle" placeholder="Título Segundário" />
                                        <span className="icon is-left">
                                            <i className="fas fa-heading"></i>
                                        </span>
                                        <span className="icon is-right">
                                ...
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <textarea onChange={handleChange} value={data.new} className="textarea pt-5" type="text" name="new" placeholder="Conteúdo da matéria"></textarea>
                                        <span className="icon is-left">
                                ...
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <input onChange={handleChange} value={data.author} className="input is-medium" type="text" name="author" placeholder="Autor da matéria" />
                                        <span className="icon is-left">
                                ...
                                <div className="field">
                                    <div className="control has-icons-left has-icons-right">
                                        <input onChange={handleChange} value={data.source} className="input is-medium" type="text" name="source" placeholder="fonte da matéria" />
                                        <span className="icon is-left">
